...
export default function ProfilePage() {
  ...
  return (
    <>
      <Navbar />
      <div className="w-full max-w-3xl mx-auto mt-10 p-8 bg-white rounded-xl shadow-lg">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          ...
          <div className="flex flex-col md:flex-row md:gap-8 mt-4 md:mt-0">
            ...
            <div>
              <span className="block text-gray-500 text-sm">Last Updated</span>
              <span className="block text-lg font-semibold">
            ...
            <div>
              <span className="block text-gray-500 text-sm">Earned Leave</span>
              <span className="block text-lg font-semibold text-green-700">{earnedLeave}</span>
            </div>
            ...
            <div key={f.name} className="mb-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="flex-1 text-lg px-4 py-2 border rounded-lg"
                />
                      ...
                      <tr key={i}>
                        {editSalaryIndex === i ? (
                          <>
                            ...
                            <td>
                              <Button size="sm" onClick={() => handleEditSave(i)} disabled={salaryLoading} className="mr-2">
        ...
        <Button variant="destructive" className="mt-8 w-40 text-lg" onClick={logout}>Logout</Button>
      </div>
...
function AddSalaryForm({ token, setUser }: { token: string; setUser: React.Dispatch<React.SetStateAction<User | null>> }) {
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Error adding salary record");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <form className="flex flex-col md:flex-row gap-2 items-end mt-4" onSubmit={handleAdd}>
      <div>
